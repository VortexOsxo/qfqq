...
def test_get_decision_by_id(app):
...
def test_get_decision_complete(app):
...
def test_get_decisions_by_notfound_responsible(app):
...
def test_get_not_found_decision(app):
    decision = DecisionDataHandler.get_decision(25)
    assert decision is None

def test_get_not_found_decision_by_responsible(app):
    decisions = DecisionDataHandler.get_decision_by_responsible(25)
    assert len(decisions) == 0

def test_get_decisions_and_responsible_by_meeting(app):
